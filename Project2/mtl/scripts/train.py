...
def main():
    ...
    checkpoint_local_callback = ModelCheckpoint(
        ...
        save_last=False,
        save_top_k=1,
        monitor='metrics_summary/multitask',
        mode='max',
    )
    ...
    wandb_logger.log_hyperparams(ec2_meta)
    tb_s3_logger.log_hyperparams({**ec2_meta, **vars(cfg)})
    ...
    trainer = Trainer(
        logger=[wandb_logger, tube_logger, tb_s3_logger],
