...
from mtl.models.model_task_distillation_with_normal import ModelTaskDistillationWithNormal
...
def resolve_model_class(name):
    return {
        ...
        'task_distillation_with_normal': ModelTaskDistillationWithNormal
    }[name]
